# Python_assessment
This is a repository created for the Devops5 Python assessment.
Solved three questions:

=======================================================================================================================================================================================

1.  In DevOps, security is a crucial aspect, and ensuring strong passwords is essential. Create a Python script to check the password strength. 
...
2. As a DevOps engineer, it is crucial to monitor the health and performance of servers. Write a Python program to monitor the health of the CPU. Few pointers to be noted:
...
3.  In DevOps, performing regular backups of important files is crucial:
...
python file_backup.py /path/to/source /path/to/destination
